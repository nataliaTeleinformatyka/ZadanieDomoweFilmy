...
public class AddTaskActivity extends AppCompatActivity {
  ...
  // private String selectedImage = "R.drawable.botoks";
    ...
    private void saveTasksToSharedPreferences(){
        ...
        Toast.makeText(this,/*getString(R.string.item_selected_msr)*/"jestem tutaj - saveTASKSadd",Toast.LENGTH_SHORT).show();
